/****************************************************************************
** Meta object code from reading C++ file 'generaldialog.h'
**
...
#include "../../UserGUI/generaldialog.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'generaldialog.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 14, 33), // "on_OkButton_GeneralDialog_cli..."
QT_MOC_LITERAL(2, 48, 0) // ""

    },
    "GeneralDialog\0on_OkButton_GeneralDialog_clicked\0"
    ""
};
...
void GeneralDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GeneralDialog *_t = static_cast<GeneralDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_OkButton_GeneralDialog_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject GeneralDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_GeneralDialog.data,
      qt_meta_data_GeneralDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GeneralDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GeneralDialog.stringdata0))
        return static_cast<void*>(const_cast< GeneralDialog*>(this));
